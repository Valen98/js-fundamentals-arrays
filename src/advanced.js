...
const indexOfFourteen = nums.lastIndexOf(14)
...
arrayToExtend.splice(nums.indexOf(8), 0, 15)
...
const newArray = nums.splice(1, 3)
const withSevenThreeEight = newArray

// 7. add the numbers from otherNums to the end of numsToMerge
numsToMerge.push(...otherNums)
const combinedNums = numsToMerge
